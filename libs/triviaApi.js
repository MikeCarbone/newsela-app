...
const API = {
    ...
    getQuestions: (sessionToken, categoryId) => fetch(`https://opentdb.com/api.php?amount=10&category=${categoryId}&token=${sessionToken}`).then(r => r.json()).catch(e => Promise.reject(e)),
